...
- **[docs/index.md](./docs/index.md)**: **文档中心入口 (推荐首读)**
- **[docs/analysis/architecture-evaluation-2026.md](./docs/analysis/architecture-evaluation-2026.md)**: **战略演进白皮书 (3.0)** — 系统的灵魂、Agent 设计与确定性架构。
- **[docs/technical-design.md](./docs/technical-design.md)**: **技术设计文档** — 当前系统的物理实现、数据流与部署指南。
- **[docs/tech-stack.md](./docs/tech-stack.md)**: **技术栈基准**。
- **[docs/archive/README.md](./docs/archive/README.md)**: 历史设计稿与归档。
...
ISC | *Powered by DeepCurrents Intelligence Engine v3.0*
